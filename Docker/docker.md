...
![image-20240309153542302](assets/image-20240309153542302.png)

点击后进入控制台：

![image-20240309153607528](assets/image-20240309153607528.png)
...
![image-20240309153656983](assets/image-20240309153656983.png)

页面向下滚动，即可找到配置的文档说明：

![image-20240309153723580](assets/image-20240309153723580.png)
...
![image-20240309161654059](assets/image-20240309161654059.png)
...
### **如果说你创建的mysql 虚拟机外连接不了**:

![image-20240309173037644](assets/image-20240309173037644.png)
...
![image-20240309173731528](assets/image-20240309173731528.png)
...
![image-20240309181018751](assets/image-20240309181018751.png)
...
![image-20240309190012214](assets/image-20240309190012214.png)

补充：

默认情况下，每次重启虚拟机我们需要手动启动Docker和Docker中的容器。通过命令可以实现开机自启：
...
![image-20240309193858300](assets/image-20240309193858300.png)
...
![image-20240309202049509](assets/image-20240309202049509.png)

以及对应的初始化SQL脚本和配置文件：

![image-20240309203234980](assets/image-20240309203234980.png)

![image-20240309203250634](assets/image-20240309203250634.png)

其中，hm.cnf主要是配置了MySQL的默认编码，改为utf8mb4；而hmall.sql则是后面我们要用到的黑马商城项目的初始化SQL脚本。

我们直接将整个mysql目录上传至虚拟机的`/root`目录下：

![image-20240309203311228](assets/image-20240309203311228.png)
...
![image-20240310104945641](assets/image-20240310104945641.png)
...
```
JDK17 的基础镜像 openjdk:17-jdk-alpine
```
...
![image-20240310105124070](assets/image-20240310105124070.png)

首先，我们将课前资料提供的`docker-demo.jar`包以及`Dockerfile`拷贝到虚拟机的`/root/demo`目录：

![image-20240310105139603](assets/image-20240310105139603.png)
...
![image-20240310105211641](assets/image-20240310105211641.png)
...
-p 18080:18080 \
-p 18081:18081 \
-v /home/oyy/java-demo/nginx/html:/usr/share/nginx/html \
-v /home/oyy/java-demo/nginx/nginx.conf:/etc/nginx/nginx.conf \
--network oyy \
nginx
```
...
![image-20240310162012169](assets/image-20240310162012169.png)

我们要部署的就是其中的`hm-service`，其中的配置文件采用了多环境的方式:

![image-20240310162030235](assets/image-20240310162030235.png)
...
![image-20240310162054634](assets/image-20240310162054634.png)

这两个变量在`application-dev.yaml`和`application-local.yaml`中并不相同：



![image-20240310162119897](assets/image-20240310162119897.png)
...
![image-20240310162135870](assets/image-20240310162135870.png)

结果：

![image-20240310162148883](assets/image-20240310162148883.png)

将`hm-service`目录下的`Dockerfile`和`hm-service/target`目录下的`hm-service.jar`一起上传到虚拟机的`root`目录：



![image-20240310162203232](assets/image-20240310162203232.png)
...
![image-20240310162242471](assets/image-20240310162242471.png)
...
![image-20240310162255119](assets/image-20240310162255119.png)
...
![image-20240310162316520](assets/image-20240310162316520.png)
